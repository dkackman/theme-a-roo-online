...
console.log(
  `Secret: ${JWT_SECRET.substring(0, 10)}...${JWT_SECRET.substring(JWT_SECRET.length - 10)}\n`
);
...
if (updatedEnv.includes("SERVICE_ROLE_KEY=")) {
  ...
  console.log(
    "⚠️  SERVICE_ROLE_KEY not found in docker/.env - please add manually"
  );
}
...
console.log(
  `   curl -H "apikey: ${ANON_KEY}" http://192.168.1.162:8000/rest/v1/`
);
console.log("");
